...
function App() {
  ...
  const claimNFTs = () => {
    let cost = 0;
    console.log("Total Supply: ", blockchain.smartContract.methods.totalSupply().call());
    if(blockchain.smartContract.methods.totalSupply().call() <= 2000){
      cost = 0;
    }
    else {
      cost = 0.005;
    ...
    blockchain.smartContract.methods
      ...
      .then((receipt) => {
        console.log(receipt);
        setFeedback(
          `Congrats, ${CONFIG.NFT_NAME} is yours! Please go visit Opensea.io to view it.`
        );
        setClaimingNft(false);
